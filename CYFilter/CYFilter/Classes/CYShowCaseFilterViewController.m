//
//  CYShowCaseFilterViewController.m
//  CYFilter
//
...
//	[backButton setTitle:@"返回" forState:(UIControlStateHighlighted | UIControlStateSelected ) ];
...
- (void)setupFilter{
	...
	[(GPUImageSharpenFilter *)filter setSharpness:4.0];
...
//	videoCamera.runBenchmark = YES;
	...
	[self.view addSubview:filterView];// (GPUImageView *)self.view;
...
//	videoCamera.outputImageOrientation = UIInterfaceOrientationPortrait;
//	
//	GPUImageFilter *customFilter = [[GPUImageSharpenFilter alloc] init];
//	[(GPUImageSharpenFilter *)customFilter setSharpness:2.0];
//	GPUImageView *filteredVideoView = [[GPUImageView alloc] initWithFrame:CGRectMake(0.0, 0.0, 320, 480)];
//	videoCamera.runBenchmark = YES;
